    ...
    <section class="third">
        ...
        <div id="tracks" class="content">
            ...
            <div class="tracks">
                <div class="card" v-for="(track,i) in tracks" :key="i">
                    <div class="inner-card">
                        ...
                        <div class="buttons">
                            <g-link style="text-decoration:none;cursor:pointer" :to="track.url">
                                <button class="learn">LEARN MORE
                                    <g-image style="width:12px;height:12px;margin-left:8px;" width="12" height="12" src="~/assets/arrows/purple-arrow.svg"/>
                                </button>
                            </g-link>
            ...
            <!-- <button class="rotating-button">
                VIEW ALL
                <g-image style="width:9px;height:9px;margin-left:8px;" width="12" height="12" src="~/assets/arrows/gold-arrow.svg"/>
            </button> -->
        </div>
    </section>
</template>
                ...
                .inner-card{
                    ...
                    .prize{
                        ...
                        .amount{
                            ...
                            line-height: 145.9%;
                            letter-spacing: -0.015em;
                            background: linear-gradient(89.97deg, #FDC506 1.39%, #FD9A06 86.07%);
